...
if [[ "$dev_global_sudo" -eq "1" ]]; then
    ...
    if [[ $# -le 0 ]]; then
        ...
        dev_kernel_info "$(dev_run dev completion dev_kernel_command_files $dev_global_wkdir/cmd)"
        exit 1
    fi
    ...
    if [[ $# -le 0 ]]; then
        ...
        dev_kernel_info "$(dev_run dev completion dev_kernel_command_functions)"
        exit 1
    fi
